// https://os.mbed.com/users/Sissors/code/MPU6050//file/5c63e20c50f3/MPU6050.h/

/*Use #define MPU6050_ES before you include this file if you have an engineering sample (older EVBs
will have them), to find out if you have one, check your accelerometer output. If it is half of what
you expected, and you still are on the correct planet, you got an engineering sample
*/
...
public:
     ...
     *
     * Macros: MPU6050_BW_256 - MPU6050_BW_188 - MPU6050_BW_98 - MPU6050_BW_42 - MPU6050_BW_20 -
     * MPU6050_BW_10 - MPU6050_BW_5 Last number is the gyro's BW in Hz (accelero BW is virtually
     * identical)
     *
    ...
    /**
     * Sets the auxiliary I2C bus in bypass mode to read the sensors behind the MPU6050 (useful for
     * eval board, otherwise just connect them to primary I2C bus)
     *
     ...
     *
     * Macros: MPU6050_ACCELERO_RANGE_2G - MPU6050_ACCELERO_RANGE_4G - MPU6050_ACCELERO_RANGE_8G -
     * MPU6050_ACCELERO_RANGE_16G
     *
     ...
     *
     * @param data - pointer to signed integer array with length three: data[0] = X, data[1] = Y,
     * data[2] = Z
     */
     ...
     *
     * Function uses the last setup value of the full scale range, if you manually set in another
     ...
     *
     * Macros: MPU6050_GYRO_RANGE_250 - MPU6050_GYRO_RANGE_500 - MPU6050_GYRO_RANGE_1000 -
    ...
    /**
     * Writes data to the device, could be private, but public is handy so you can transmit directly
     * to the MPU.
     *
    ...
    /**
     * Read data from the device, could be private, but public is handy so you can transmit directly
     * to the MPU.
     *
     * @param adress - register address to write to
